...
# BiocManager::install()
# BiocManager::install(c("DESeq2", "edgeR", "stringr"))
...
## Run DESeq2 to calculate the differentially expressed transcripts between E3.5, E4.5, and E5.5
...
E4.5_vs_E3.5 <- results(dds, contrast = c("stage", "E4.5_Epi", "E3.5_ICM"), alpha = 0.05)
